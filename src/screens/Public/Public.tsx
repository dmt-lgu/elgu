  ...
  const SidebarContent = ({ onClose }: { onClose?: () => void }) => (
    <>
      ...
      <nav className="flex-1 overflow-y-auto px-2 py-3 space-y-0.5">
        {navLink('/elgu/main/dashboard', 'Dashboard', LucideLayoutDashboard, onClose)}
        {navLink('/elgu/main/report', 'Reports', BarChart3Icon, onClose)}
      </nav>
  ...
  return (
    <ThemeProvider defaultTheme="light" storageKey="vite-ui-theme">
      <div className="flex h-screen bg-background">
        ...
        {/* Desktop Sidebar */}
        <aside className="md:hidden w-64 bg-[#0f172a] flex flex-col shrink-0">
          <SidebarContent />
        </aside>
