          ...
          <TableBody>
            {filteredData.map((data) => (
              <TableRow key={data.region}>
                <TableCell className="border px-2 py-1 font-semibold text-start">{data.region}</TableCell>
                <TableCell className="border px-2 py-1 text-center">{data.newPaid}</TableCell>
                <TableCell className="border px-2 py-1 text-center">{data.newGeoPay}</TableCell>
                <TableCell className="border px-2 py-1 text-center">{data.newPending}</TableCell>
                <TableCell className="border px-2 py-1 text-center font-bold">{data.newTotal}</TableCell>
                <TableCell className="border px-2 py-1 text-center">{data.renewalPaid}</TableCell>
                <TableCell className="border px-2 py-1 text-center">{data.renewalGeoPay}</TableCell>
                <TableCell className="border px-2 py-1 text-center">{data.renewalPending}</TableCell>
                <TableCell className="border px-2 py-1 text-center font-bold">{data.renewalTotal}</TableCell>
                <TableCell className="border px-2 py-1 text-center">{data.malePaid}</TableCell>
                <TableCell className="border px-2 py-1 text-center">{data.malePending}</TableCell>
                <TableCell className="border px-2 py-1 text-center font-bold">{data.maleTotal}</TableCell>
                <TableCell className="border px-2 py-1 text-center">{data.femalePaid}</TableCell>
                <TableCell className="border px-2 py-1 text-center">{data.femalePending}</TableCell>
                <TableCell className="border px-2 py-1 text-center font-bold">{data.femaleTotal}</TableCell>
              </TableRow>
            ))}
