...
import DashboardProgressIndicator from '../Admin/Dashboard/components/DashboardProgressIndicator';
...
function Master() {
  ...
  const displayName = [currentUser.first_name, currentUser.last_name].filter(Boolean).join(' ') || currentUser.email || 'Master';
      ...
      <div className="flex h-screen">
        ...
        <aside className="md:hidden flex w-[300px]  bg-card border-r border-border flex-col">
          ...
          <nav className="flex flex-col mt-10  ">
            {/* <Link
              to="/elgu/master/dashboard"
              className={`flex items-center gap-2 ${
                location.pathname === "/elgu/master/dashboard"
            ...
            <Link
              to="/elgu/master/report"
              className={`flex items-center gap-2 ${
                location.pathname === "/elgu/master/report"
                  ? "text-white bg-[#282b30] font-medium w-full p-2  pl-10 py-5 "
                  : "text-secondary-foreground w-full p-2  pl-10 py-5 "
              }`}
            >
            ...
            {manageOpen && [
              { to: '/elgu/master/manage/general',  code: 'GEN',  label: 'General',                             Icon: FileTextIcon },
              { to: '/elgu/master/manage/epayment', code: 'EPAY', label: 'ePayment',                          Icon: FileTextIcon },
              { to: '/elgu/master/manage/bp1',  code: 'BP1',  label: 'Business Permit',                    Icon: FileTextIcon },
            ...
            <div className="mt-6 mx-4 border-t border-border" />
            <Link
              to="/elgu/master/audit-trail"
              className={`flex items-center gap-2 ${
                location.pathname === "/elgu/master/audit-trail"
                  ? "text-white bg-[#282b30] font-medium w-full p-2 pl-10 py-5"
                  : "text-secondary-foreground w-full p-2 pl-10 py-5"
              }`}
            >
            ...
            <Link
              to="/elgu/master/accounts"
              className={`flex items-center gap-2 ${
                location.pathname === "/elgu/master/accounts"
                  ? "text-white bg-[#282b30] font-medium w-full p-2 pl-10 py-5"
                  : "text-secondary-foreground w-full p-2 pl-10 py-5"
              }`}
            >
            ...
            <Link
              to="/elgu/master/offices"
              className={`flex items-center gap-2 ${
                location.pathname === "/elgu/master/offices"
                  ? "text-white bg-[#282b30] font-medium w-full p-2 pl-10 py-5"
                  : "text-secondary-foreground w-full p-2 pl-10 py-5"
              }`}
            >
              ...
              <div className="flex-1 flex justify-end items-center gap-3">
                ...
                >
                  ...
                  <div className="text-left leading-tight">
                    <p className="text-sm font-semibold text-gray-800 truncate max-w-[160px]">{displayName}</p>
                    {displayEmail && (
